		...
		<div class="portlet box grey-cascade">
			...
			<div class="portlet-body form">
				<form class="form-horizontal form-bordered ng-pristine ng-valid" id="formTemplate" name="formTemplate" novalidate >
					<input type="hidden" name="template_id" data-ng-model="template_id">
						
					<div class="form-group">
						<label class="col-sm-3 control-label">Template Name <span class="required"> * </span></label>
						<div class="col-sm-4">
...
<span ng-show="formTemplate.template_name.$error.required">Template Name is required.</span>
								</span>
							</div>
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-offset-3 col-md-9">
								<button class="btn purple" ng-disabled="formTemplate.$invalid" type="submit" data-ng-click="templateUpdate()" ><i class="fa fa-check"></i> Submit</button>&nbsp;
