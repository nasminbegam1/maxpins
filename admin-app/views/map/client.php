        ...
        <div class="col-md-4">
            <div class="portlet light">                
                    <div class="portlet-body form">
                        ...
                        <div class="form-group">
                                <input type="text" data-ng-model="agentId" placeholder="Agent Id" class="form-control">
                    ...
                    <div class="portlet-body form">
                        <div class="intraction-contener">
                            <div class="intraction-controll">    
                                <div class="deny {{clinetDenyBtn_show_hide?clinetDenyBtn_show_hide:'ng-hide'}}" data-ng-click="deny();"><i class="fa fa-phone"></i></div>
                                <div class="disconnected  {{disconnected_show_hide?disconnected_show_hide:'ng-hide'}}" >Disconnected</div>
                                <div class="intraction-loader {{intractionLoader_show_hide?intractionLoader_show_hide:'ng-hide'}}"><img src="images/ajax-modal-loading.gif" alt="Processing..." /></div>
                                <div class="video-stream {{videoDisable_show_hide?videoDisable_show_hide:'ng-hide'}} {{videoDisable?videoDisable:'enable'}}" ng-click="toggleVideoDisable();"><i class="fa fa-video-camera"></i></div>
                                <div class="callback  {{clientCallback_show_hide?clientCallback_show_hide:'ng-hide'}}" ng-click="calling();" ><img src="images/callbackIcon.png" alt="Call Back">Call Back</div>
                                <div class="calling {{clientCall_show_hide?clientCall_show_hide:'ng-hide'}}" ng-click="calling();"></div>
                            </div>    
                            <div id="videos">
            ...
            <div class="portlet light">
                <div class="portlet-title">
                    ...
                    <div class="portlet-body form">
                        <div class="form-group">
                                <input type="text" data-ng-model="name" placeholder="Enter Name" class="form-control">
...
<!--                        <div class="form-group">
                            <button class="btn btn-success" ng-click="closeChat()">Close Chat</button>
                        </div>
-->
      ...
      <div class="map-unit">
        ...
        <div class="map-content"><img class="map" src="images/map.jpg" /></div>
            ...
            <div class="brochureBox">
                <ul>
                    <li data-ng-repeat="b in borchure">
                        <span class="bImg">
                            <img data-ng-src="{{b.image}}" />
                        </span>
                        <span class="bName" data-ng-bind="b.name"></span>
                    </li>
                </ul>
            </div>
        </div>
