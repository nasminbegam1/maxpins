			...
			<div class="portlet-body form">
				<form class="form-horizontal form-bordered ng-pristine ng-valid" id="formaddproduct" name="frmaddproduct" novalidate  >
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" class="form-control" name="product_sku" placeholder="" data-ng-model="product_sku" readonly="readonly">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<span style="color:red" ng-show="hasError('product_name', 'required')">Product name is required.</span>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<select name="product_type" data-ng-model="product_type" class="form-control" required>
								...
								<option ng-selected="{{p_type.id == selected_product_type}}" ng-repeat="p_type in product_type_list" value="{{p_type.id}}">
										  {{p_type.type_name}}
										</option>
							</select>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<span style="color:red" ng-show="hasError('product_item_count', 'required')">item count is required.
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6">
							<div class="form-control height-auto">
								<div class="scroller" style="height:200px;" data-always-visible="1" data-ng-init="selected_category">
									<ul class="list-unstyled">
										<li data-ng-repeat="c in category">
											
											<label><input checkbox-group-category type="checkbox" name="product[categories][]" value="{{c.category_id}}"> {{c.category_name}}</label>
										</li>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<select class="table-group-action-input form-control input-medium" name="product_status" data-ng-model="product_status" required>
								...
								<option value="Active" data-ng-selected="product_status=='Active'">Yes</option>
								<option value="Inactive" data-ng-selected="product_status=='Inactive'">No</option>
							</select>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<select class="table-group-action-input form-control input-medium" name="product_reorder_status" data-ng-model="product_reorder_status">
								<option value="">Select...</option>
								<option value="Yes" data-ng-selected="auto_reorder=='yes'">Yes</option>
								<option value="No" data-ng-selected="auto_reorder=='no'">No</option>
							</select>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<span style="color:red" ng-show="hasError('product_price', 'required')">Product price is required.</span>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<select name="is_featured" ng-model="is_featured" class="form-control">
								<option value="Yes" selected="{{is_featured == 'Yes' ? 'selected' : ''}}">Yes</option>
								<option value="No" selected="{{is_featured == 'No' ? 'selected' : ''}}">No</option>
							</select>
						</div>
					</div>
								...
								<div class="scroller" style="height:200px;" data-always-visible="1">
									<ul class="list-unstyled">
										<li data-ng-repeat="w in wholesalers">
											<label><input checkbox-group-retailer type="checkbox" name="product[retailer][]" value="{{w.wholesaler_id}}"> {{w.wholesaler_name}}</label>
										</li>
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-offset-3 col-md-9">
								<input type="text" style="display: none;" data-ng-model="product_id" name="product_id"/>
								<button class="btn purple"  type="submit" data-ng-click="productUpdate($event)" ><i class="fa fa-check"></i> Submit</button>
