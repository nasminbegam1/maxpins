	...
	<div class="row">
		...
		<div class="portlet box grey-cascade">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-gift"></i>Edit Shipping Method
				</div>
			...
			<div class="portlet-body form">
				<form class="form-horizontal form-bordered ng-pristine ng-valid" id="formShippingMethod" name="formShippingMethod" novalidate >
					<input type="hidden" name="id" value="{{id}}" data-ng-model="id">
...
<span ng-show="formShippingMethod.method_status.$error.required">Status is required.</span>
					...
					<div class="form-group" data-ng-repeat="price in prices">
						...
						<div class="col-sm-3">
							<div class="input-group">
								...
								<input type="text" class="form-control tt-hint" name="lower_qty[]" ng-pattern='/^\d+$/'  data-ng-model="price.lower_qty"  required>
						...
						<div class="col-sm-3">
							<div class="input-group">
								...
								<input type="text" class="form-control tt-hint" ng-pattern='/^\d+$/' name="higher_qty[]"  data-ng-model="price.higher_qty"  required>
							</div>
						</div>
						<div class="col-sm-3">
							<div class="input-group">
								<label>Price</label>
								<input type="text" class="form-control tt-hint"  name="price[]" ng-pattern='/^\-?\d+((\.|\,)\d+)?$/'   data-ng-model="price.price"   required>								
							</div>
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-offset-3 col-md-9">
								<button class="btn purple" ng-disabled="formShippingMethod.$invalid" type="submit" data-ng-click="methodUpdate()" ><i class="fa fa-check"></i> Submit</button>&nbsp;
