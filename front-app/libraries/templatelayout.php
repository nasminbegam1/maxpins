...
class templatelayout {
     ...
     public function get_footer(){
	  ...
	  $this->footer['webmaster_email']	= $record[0]['sitesettings_value'];
	  $this->footer['sitename']		= $record[1]['sitesettings_value'];
	  $this->footer['facebook_link']	= $record[2]['sitesettings_value'];
	  $this->footer['twitter_link']		= $record[3]['sitesettings_value'];
	  $this->footer['phone_no']		= $record[4]['sitesettings_value'];
	  $this->footer['googleplus_link']	= $record[5]['sitesettings_value'];
	  $this->footer['linkedin_link']	= $record[6]['sitesettings_value'];
	  $this->footer['myspace_link']		= $record[7]['sitesettings_value'];
	  $this->footer['pinterest_link']	= $record[4]['sitesettings_value'];
