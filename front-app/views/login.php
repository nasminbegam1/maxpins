<div class="loginPage">
	...
	<div class="loginBox">
		...
		<form id="formLogin" name="formLogin" data-ng-model="formLogin" novalidate>
			...
			<span class="createAccount">Or</span>
			<button class="loginBtn" type="submit" data-ng-click="createAccount()">Apply for Wholesaler Account</button>
			<!--Create your account</a></span> --><br class="spacer" />
